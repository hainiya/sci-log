...
export declare function HanaThemeProvider({ mode, theme, className, style, children, 'data-testid': dataTestId, ...rootProps }: HanaThemeProviderProps): import("react/jsx-runtime").JSX.Element;
